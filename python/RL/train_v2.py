...
from rl_model_v2 import PolicyGradient_chatbot
...
def train():
    ...
    with g2.as_default():
        reversed_model = Seq2Seq_chatbot(
            ...
            lr=learning_rate)
        _, _, word_vectors, caption, caption_mask, reverse_inter = reversed_model.build_model() #error
        sess2 = tf.compat.v1.InteractiveSession()#config=tf.compat.v1.ConfigProto(allow_soft_placement=True, log_device_placement=True))
    ...
    for epoch in range(start_epoch, epochs):
        ...
        pbar = tqdm(range(sb, n_batch), desc='Start')
        for batch in pbar:
            ...
            if training_type == 'pg':
                ...
                backward_inter = sess2.run(reverse_inter,
                                 feed_dict={
                                    ...
                                    caption_mask: former_caption_masks ###eror
                                })
